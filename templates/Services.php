...
<div class="page-container-am page-container services-page-am">
    <main>
            ...
            <div class="container-am">
                ...
                <div class="cta-banner services-cta-am">
                    <div>
                        ...
                        <p><?php echo esc_html($why_group['cta_description'] ?? 'Talk to our team and choose the support path that fits your goals.'); ?>
                        </p>
                    </div>
                ...
                <div class="pillars-grid services-pillars-grid-am">
                    ...
                    <div class="pillar-item services-pillar-am">
                        <div class="pillar-icon services-pillar-icon-am">
                            <iconify-icon icon="<?php echo esc_attr($pillar['icon'] ?? 'lucide:shield-check'); ?>">
                            </iconify-icon>
                        </div>
                    ...
                    <div class="approach-col services-approach-col-am">
                        <h3>
                            <div class="icon-wrapper">
                                <iconify-icon icon="<?php echo esc_attr($column['icon'] ?? 'lucide:check-circle'); ?>"
                                    style="font-size:24px"></iconify-icon>
                            </div>
                            <?php echo esc_html($column['title'] ?? ''); ?>
                        </h3>
                        <?php if (!empty($column['text'])) : ?>
                        <p class="approach-text"><?php echo $column['text']; ?></p>
                        <?php endif; ?>
          ...
          ?>
                    <div class="team-card services-team-card-am">
                        ...
                        <img src="<?php echo esc_url($img_url); ?>" alt="<?php echo esc_attr($img_alt); ?>"
                            class="team-avatar services-team-avatar-am" />
                        <?php endif; ?>
                        <h4><?php the_title(); ?></h4>
                        <?php if (!empty($role)) : ?>
                        ...
                        <a href="<?php the_permalink(); ?>"
                            class="btn btn-am btn-outline btn-outline-am services-team-btn-am" style="width:100%"
                            data-media-type="banani-button">
                            View Profile
                        </a>
                    </div>
        ...
        <section class="faq-section-am container-am">
            ...
            <div class="faq-list-am">
                <?php foreach ($faq_group['items'] as $index => $faq) : ?>
                <div class="faq-item-am">
                    <div class="faq-question-am" data-media-type="banani-button">
                        <?php echo esc_html($faq['question'] ?? 'How can I determine if psychotherapy will be helpful?'); ?>
                        <div style="
                      width: 20px;
                      height: 20px;
                      display: flex;
                    ...
                    ">
                            <iconify-icon icon="lucide:<?php echo $index === 0 ? 'chevron-up' : 'chevron-down'; ?>"
                                style="font-size: 20px; color: <?php echo $index === 0 ? 'var(--primary)' : 'var(--muted-foreground)'; ?>">
                            </iconify-icon>
                        </div>
                    </div>
                    <div class="faq-answer-am">
                        <?php echo $faq['answer'] ?? ''; ?>
                    </div>
                </div>
                <?php endforeach; ?>
