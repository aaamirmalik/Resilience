    ...
    <header class="page-header-am">
        <div class="container-am">
            ...
            <div class="team-filters-am">
                ...
                <?php
                    $terms = get_terms([
                        'taxonomy' => 'team-category', // your taxonomy
                        'hide_empty' => true,
                    ]);
    ...
    <section class="team-directory-section-am">
        <div class="container-am">
            <div class="team-directory-grid-am">
                ...
                <div class="team-card-am<?php echo esc_attr($term_classes); ?>">
                    ...
                    <div class="team-card-content-am">
                        ...
                        <a href="<?php the_permalink(); ?>" class="btn-am btn-outline-am" style="width:100%">
                            View Profile
                        </a>
